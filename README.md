...
本プラットフォームは、**AIをアシスタントに迎えて開発** しました。その過程で痛感したのが、AIの「もっともらしい嘘」への対策の重要性です。
...
- **聖域のチェック**：「揚抗比」を重視しているか、「付着ジェット／剥離ジェット」の呼称が正しいか、「擬似翼モード」の分類に沿っているかなど、研究室独自の知見をチェック項目として組み込みました。
